...
- macOS is the same pattern: snapshot under `flutter/macos/gazepoint_sdk/Sources/gazepoint_sdk/GazePointSDK`. Releasing GazePointSDK-macOS does not update Flutter until that snapshot is copied.
