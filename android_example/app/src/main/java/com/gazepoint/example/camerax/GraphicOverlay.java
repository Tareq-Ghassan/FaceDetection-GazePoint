...
/**
 * Overlay view for drawing face graphics on the camera preview.
 */
    ...
    public abstract static class Graphic {
        ...
        public RectF calculateRect(float height, float width, Rect boundingBoxT) throws Exception {
            Callable<Boolean> isLandscapeMode = () ->
                    overlay.getContext().getResources().getConfiguration().orientation
                            == Configuration.ORIENTATION_LANDSCAPE;

            Callable<Float> whenLandscapeModeWidth = () -> isLandscapeMode.call() ? width : height;
            Callable<Float> whenLandscapeModeHeight = () -> isLandscapeMode.call() ? height : width;
